...
func TestObservationNFullMatchesDefault(t *testing.T) {
	...
	ring := Ring(date)
	ringN := RingN(date, -1)
	assertSame("Ring.EarthLatitude", ring.EarthLatitude, ringN.EarthLatitude)
	assertSame("Ring.SunLatitude", ring.SunLatitude, ringN.SunLatitude)
	assertSame("Ring.PositionAngle", ring.PositionAngle, ringN.PositionAngle)
	assertSame("Ring.DeltaU", ring.DeltaU, ringN.DeltaU)
	assertSame("Ring.MajorAxis", ring.MajorAxis, ringN.MajorAxis)
	assertSame("Ring.MinorAxis", ring.MinorAxis, ringN.MinorAxis)
